...
{
    public class LDPatientDiagnosisController : Controller
    {
        private readonly PatientsContext _context;

        public LDPatientDiagnosisController(PatientsContext context)
        {
            _context = context;
        }

        // GET: LDPatientDiagnosis
        public async Task<IActionResult> Index()
        {
            //Should check whether if it is right or not
            var patientsContext = _context.PatientDiagnosis.Include(p => p.Diagnosis).Include(p => p.Patient).OrderBy(p => p.Patient.FirstName).OrderByDescending(p => p.DiagnosisId);
            return View(await patientsContext.ToListAsync());
        }

        // GET: LDPatientDiagnosis/Details/5
        ...
        // POST: LDPatientDiagnosis/Create
        ...
        // POST: LDPatientDiagnosis/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: LDPatientDiagnosis/Delete/5
        ...
        // POST: LDPatientDiagnosis/Delete/5
